...
function App() {
    ...
    return (
        <>
            ...
            <div>
                <div
                    // שי מחק את כל מה שהיה בקובץ app.css כדי לעשות עיצוב לקומפוננטה על ידי מחלקות custom
                    // יש סיפריות מיועדות בריאקט של styling אבל לא נשתמש בהן כדי ללמוד את הבסיס.
                style={{
                    ...
                    borderRadius:'30px'
                    //נגיד יש לי לאמנט כפתור ואני ארצה שהוא כל פעם יהיה מעוצב בכל פעם שאצור כפתור, אז אנחנו ניצור קומפוננטה חדשה עבור הסטייל של הכפתור - custom button
                    ...
                    />
                    <CustomInput // אותו עיצוב של טיבת האינפוט
                        placeholder={"Enter last name"}
                        value={lastName}
                        onChange={(event) => {
                            setLastName(event.target.value)
                        }}/>
                    {/* מה שעשינו כאן בעצם, העברנו את כל מה שהיה בכפתור לתוך הקאסטום באטן-למה? כדי שהוא יוכל לקבל כל קונספט עיצובי שאנחנו נרצה ונוכל ליצור עוד כפתורים עם אותו העיצוב*/}
                    <CustomButton
                        // השדות (מה שמקבל בפרופס בקומפוננטת הכפתור):
                        text={"Add"}
